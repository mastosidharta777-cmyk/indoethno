...
export const baliStayAreas=stayAreaRecords.map(item=>({...item,...verifiedStatus}));
...
export const baliTransport=transportRecords.map(item=>({...item,...verifiedStatus}));

const homepageExperienceRecords:TravelInventorySource[]=[
  ...
  {productName:"Airport Transfer in Bali",editorialTitle:"Arrive in Bali with your transfer arranged",location:"BALI · AIRPORT TRANSFER",description:"Compare current airport transfer options to Ubud, Kuta, Seminyak, and beyond.",image:"/images/bali-airport-transfer.png",priceLabel:"Check latest price",sourceUrl:"https://www.traveloka.com/en-id/airport-transfer/to/bali",affiliateUrl:null,interests:[]},
];

export const homepageExperiences:TravelInventoryItem[]=homepageExperienceRecords.map(item=>({...item,...verifiedStatus}));

export const homepageStays=[
 {...verifiedStatus,place:"Bali",type:"For rice-field stillness",productName:"Browse stays in Bali",name:"Browse stays in Bali",priceLabel:"Check latest price" as const,price:"Check latest price",image:"/images/stay-sidemen.png",sourceUrl:"https://www.traveloka.com/id-id/hotel/indonesia/region/bali-102746",affiliateUrl:null},
 {...verifiedStatus,place:"Yogyakarta",type:"For art and old Java",productName:"Browse stays in Yogyakarta",name:"Browse stays in Yogyakarta",priceLabel:"Check latest price" as const,price:"Check latest price",image:"/images/stay-yogyakarta.png",sourceUrl:"https://www.traveloka.com/en-id/hotel",affiliateUrl:null},
 {...verifiedStatus,place:"Lombok",type:"For barefoot coastlines",productName:"Browse stays in Lombok",name:"Browse stays in Lombok",priceLabel:"Check latest price" as const,price:"Check latest price",image:"/images/stay-lombok.png",sourceUrl:"https://www.traveloka.com/en-id/hotel",affiliateUrl:null},
 {...verifiedStatus,place:"Labuan Bajo",type:"For island horizons",productName:"Browse stays in Labuan Bajo",name:"Browse stays in Labuan Bajo",priceLabel:"Check latest price" as const,price:"Check latest price",image:"/images/stay-labuan-bajo.png",sourceUrl:"https://www.traveloka.com/en-id/hotel",affiliateUrl:null},
];
