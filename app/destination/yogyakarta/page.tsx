...
export default function YogyakartaPage() {
  ...
  return (
    <>
      ...
      <main>
        <div className="shell heroShell">
          <section className="destinationHero">
            ...
            <div className="destinationFact"><span>From sound to place</span><strong>Yogyakarta</strong><p>Follow the journey into culture, nearby discoveries, detours and a place to stay.</p></div>
          </section>
        </div>
        ...
        <div className="shell">
          ...
          <section className="section" id="around">
            <div className="sectionHead">
              ...
              <p>These places sit within {AROUND_HERE_MAX_DISTANCE_KM.toFixed(1)} km in straight-line distance from the Ngasem festival ground. It keeps this first part of the journey compact while staying clear that walking or driving routes may be longer.</p>
            </div>
          ...
          <section className="section" id="detours">
            <div className="sectionHead"><div><p className="eyebrow">Worth a detour</p><h2>When the trip wants to go further</h2></div><p>These are not quick nearby add-ons. Each one asks for more time, and that is exactly why it can become a memorable chapter of the trip.</p></div>
          ...
          <section className="section staySection" id="stay">
            <div className="sectionHead"><div><p className="eyebrow">Stay</p><h2>Choose a base that fits the story</h2></div><p>Once the route starts to feel real, the stay becomes part of the decision. These properties fit different versions of a Yogyakarta journey; live price and availability are not implied.</p></div>
      ...
      <div className="planbar"><span><strong>Shape your Yogyakarta trip</strong><small>Save the chapters you want to keep</small></span><Link className="btn" href="/plan">Open trip</Link></div>
      <footer className="shell footer"><span>IndoEthno · Yogyakarta</span><span>Music, place and culture in one journey</span></footer>
    </>
  );
}
