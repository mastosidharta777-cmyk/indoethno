...
export default function YogyakartaPage() {
  ...
  return (
    <>
      ...
      <main>
        <div className="shell heroShell">
          <section className="destinationHero">
            ...
            <div className="destinationFact"><span>Pilot logic</span><strong>Culture first.</strong><p>Generic travel inventory comes after the reason to care.</p></div>
          </section>
        </div>
      ...
      <div className="planbar"><span><strong>Save culture, stays and detours</strong><small>No account required in the pilot</small></span><Link className="btn" href="/plan">Open trip</Link></div>
      <footer className="shell footer"><span>Yogyakarta pilot</span><span>Nearby and detour are intentionally separate</span></footer>
    </>
  );
}
